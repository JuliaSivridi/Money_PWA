  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: pinned to top, full width, scrollable — keyboard pushes content up
        'inset-x-0 top-0 max-h-dvh overflow-y-auto rounded-b-xl p-5 border-b',
        'data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top',
        // Desktop sm+: centered
        'sm:inset-x-auto sm:top-[50%] sm:left-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:p-6 sm:border',
